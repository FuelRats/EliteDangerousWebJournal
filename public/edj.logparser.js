    ...
    if (edj.isJson(line)) {
      ...
      switch (logItem.event) {
        ...
        case 'LoadGame':
          ...
          break;
        case 'Location':
          edjdata.player.pos = _objectSpread(_objectSpread({}, edjdata.player.pos), logItem);
          break;
        case 'StartJump':
          edjdata.player.pos = _objectSpread(_objectSpread({}, edjdata.player.pos), logItem);
        ...
        case 'FSDJump':
          ...
          break;
        case 'Shipyard':
          edjdata.player.pos = _objectSpread(_objectSpread({}, edjdata.player.pos), {
        ...
        case 'Materials':
          ...
          edjdata.player.materials = _objectSpread(_objectSpread({}, edjdata.player.materials), {
            Raw: logItem.Raw,
