...
const edjGui = {
  ...
  canSynthesizeLifesupport() {
    const strings = [];
    strings.push(edjdata.cansynthesizelifesupport ? 'You can synthesize at least one full life-support refill' : 'You do not have enough iron or nickel to manufacture a full life-support refill');
    ...
    if (edjdata.oxygenRemaining !== null) {
      strings.push(`Oxygen remaining: ${edjdata.oxygenRemaining / 1000} seconds`);
    }

    document.getElementById('canSynthOxygen').innerHTML = strings.join('<br />');
  },
